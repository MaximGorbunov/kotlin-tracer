...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto;
}  // extern "C"
namespace perfetto {
namespace protos {
enum AtomId : int;
...
[[nodiscard]] inline bool AtomId_IsValid(int value) {
...
AtomId_descriptor();
[[nodiscard]] inline auto ProtobufInternalGetEnumDescriptor(AtomId) {
  return AtomId_descriptor();
}
template <typename T>
[[nodiscard]] const ::std::string& AtomId_Name(T value) {
  static_assert(::std::is_same<T, AtomId>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to AtomId_Name().");
  return ::google::protobuf::internal::NameOfEnum(AtomId_descriptor(), value);
}
[[nodiscard]] inline bool AtomId_Parse(
    ::absl::string_view name, AtomId* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<AtomId>(AtomId_descriptor(), name,
                                           value);
}
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::perfetto::protos::AtomId>() {
