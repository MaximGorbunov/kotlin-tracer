...
#ifndef protos_2fperfetto_2ftrace_2ftrace_2eproto_2epb_2eh
#define protos_2fperfetto_2ftrace_2ftrace_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_protos_2fperfetto_2ftrace_2ftrace_2eproto;
}  // extern "C"
namespace perfetto {
namespace protos {
class Trace;
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED Trace final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:perfetto.protos.Trace) */ {
 public:
  ...
  explicit constexpr Trace(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const Trace& default_instance() {
  ...
  [[nodiscard]] Trace* PROTOBUF_NONNULL
 ...
 public:
  ...
  public:
  void clear_packet() ;
  [[nodiscard]] ::perfetto::protos::TracePacket* PROTOBUF_NONNULL mutable_packet(int index);
  [[nodiscard]] ::google::protobuf::RepeatedPtrField<::perfetto::protos::TracePacket>* PROTOBUF_NONNULL
  mutable_packet();
  ...
  public:
  [[nodiscard]] const ::perfetto::protos::TracePacket& packet(int index) const;
  ::perfetto::protos::TracePacket* PROTOBUF_NONNULL add_packet();
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::perfetto::protos::TracePacket>& packet()
      const;
...
inline ::perfetto::protos::TracePacket* PROTOBUF_NONNULL Trace::add_packet()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::perfetto::protos::TracePacket* _add =
...
#endif  // protos_2fperfetto_2ftrace_2ftrace_2eproto_2epb_2eh
