...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_protos_2fperfetto_2ftrace_2fandroid_2fgraphics_2frect_2eproto;
}  // extern "C"
namespace perfetto {
namespace protos {
class RectProto;
...
extern const ::google::protobuf::internal::ClassDataFull RectProto_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED RectProto final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:perfetto.protos.RectProto) */ {
 public:
  ...
  [[nodiscard]] static const RectProto& default_instance() {
  ...
  inline void Swap(RectProto* PROTOBUF_NONNULL other) {
  ...
  [[nodiscard]] RectProto* PROTOBUF_NONNULL
  New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<RectProto>(arena);
  }
