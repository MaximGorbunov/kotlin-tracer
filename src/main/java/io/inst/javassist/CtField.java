...
public class CtField extends CtMember {
     ...
     * a descriptor.
     *
     * @see io.inst.javassist.bytecode.Descriptor
     ...
     * It represents a type including type variables.
     * See {@link io.inst.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see io.inst.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see io.inst.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
