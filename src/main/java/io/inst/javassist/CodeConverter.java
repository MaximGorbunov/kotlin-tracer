 ...
 *
 * @see io.inst.javassist.CtClass#instrument(CodeConverter)
 * @see io.inst.javassist.CtMethod#instrument(CodeConverter)
...
public class CodeConverter {
     ...
     * @see io.inst.javassist.CtMethod#setName(String)
     */
