...
class Instrumentation {
 public:
  ...
  void instrument(jvmtiEnv* jvmti_env, JNIEnv* jni_env, const char* name, jint class_data_len,
 ...
 private:
  ...
  jbyteArray instrumentMethod(const unsigned char* byte_code, int size,
